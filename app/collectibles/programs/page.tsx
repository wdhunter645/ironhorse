  ...
  return (
    <div className='space-y-8'>
      <header className='text-center py-12 bg-gradient-to-r from-vintage-brown to-amber-900 text-vintage-cream rounded-lg shadow-lg border-vintage-gold'>
        <h1 className='text-5xl font-bold mb-4 vintage-heading'>Programs & Publications</h1>
        <p className='text-xl mb-2 vintage-text text-vintage-cream'>Game Programs, Magazines, and Historical Documents</p>
        <p className='text-lg opacity-90 vintage-text text-vintage-cream'>Coming Soon - Publications archive</p>
      </header>
      ...
      <nav className='text-sm vintage-text'>
        ...
        <span className='mx-2'>›</span>
        <span className='font-semibold text-vintage-brown'>Programs & Publications</span>
      </nav>
