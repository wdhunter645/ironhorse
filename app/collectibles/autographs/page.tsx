  ...
  return (
    <div className='space-y-8'>
      <header className='text-center py-12 bg-gradient-to-r from-vintage-brown to-amber-900 text-vintage-cream rounded-lg shadow-lg border-vintage-gold'>
        <h1 className='text-5xl font-bold mb-4 vintage-heading'>Lou Gehrig Autographs</h1>
        <p className='text-xl mb-2 vintage-text text-vintage-cream'>Authenticated Signatures from the Iron Horse</p>
        <p className='text-lg opacity-90 vintage-text text-vintage-cream'>Coming Soon - Comprehensive autograph collection showcase</p>
      </header>
      ...
      <nav className='text-sm vintage-text'>
        ...
        <span className='mx-2'>›</span>
        <span className='font-semibold text-vintage-brown'>Autographs</span>
      </nav>
